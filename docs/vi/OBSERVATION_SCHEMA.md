...
| `matrix` | [int,int] | [16, 9] | Kích thước viewport_blocks: [width, height] |

`width × height = 16 × 9 → 288 giá trị (144 cặp [depth, blockId]).`
...
- **32**: thông thoáng (không vật cản trong phạm vi)
